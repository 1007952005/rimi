...
/*************************************************/
// 调用“设置子导航的一级导航”函数
setSubNavMenu(goodsNav);

// 调用“设置子导航的二级导航”函数
setSubNavMenu_lv2(goodsNav)
 ...
 * 参数：数据（object）
**/
function setSubNavMenu_lv2(navData) {
	// 子导航列表容器内的一级导航菜单列表集合
	...
	for(var i = 0; i < goodsNavList_leng; i++) {
		...
		currentList.onmouseenter = function() {
			// 获取对应二级导航数据及长度
			var navData_lv2 = navData[this.index].goodsNav,
				navData_lv2_leng = navData.length;
